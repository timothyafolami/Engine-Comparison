...
def select_features(
    ...
    excluded = ["mileage_km", "energy_consumption", target_variable]
    ...
    corrs = data[avail + [target_variable]].corr()[target_variable].abs().sort_values(ascending=False)
    feature_corrs = corrs.drop(target_variable)
