"""
Thin wrapper to run the new modular enhanced pipeline in ve.pipeline.
Preserves backward-compatible entrypoint: `python enhanced_vehicle_efficiency_analysis.py`.
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Enhanced Vehicle Efficiency Analysis (modular)")
